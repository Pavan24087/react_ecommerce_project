...
const CartPage = () => {
    ...
    const cartItemTotal = cartItems.map(item => item.quantity).reduce((prevValue,curValue) => prevValue + curValue, 0);
    console.log(cartItemTotal);

    const cartTotal = cartItems.map(item => item.price * item.quantity).reduce((prevValue,curValue) =>prevValue + curValue, 0);
